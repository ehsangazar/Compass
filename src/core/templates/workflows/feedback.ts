...
export function getFeedbackSkillTemplate(): SkillTemplate {
  return {
    name: 'feedback',
    description: 'Collect and submit user feedback about Compass with context enrichment and anonymization.',
    instructions: `Help the user submit feedback about Compass.
...
5. **Submit on confirmation**
   - Use the \`compass feedback\` command to submit
   - Format: \`compass feedback "title" --body "body content"\`
