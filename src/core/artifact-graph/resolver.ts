...
export function getProjectSchemasDir(projectRoot: string): string {
  return path.join(projectRoot, 'compass', 'schemas');
}
 ...
 * 1. Project-local: <projectRoot>/compass/schemas/<name>/schema.yaml
 * 2. User override: ${XDG_DATA_HOME}/compass/schemas/<name>/schema.yaml
