...
// Constants
export const GLOBAL_CONFIG_DIR_NAME = 'compass';
export const GLOBAL_CONFIG_FILE_NAME = 'config.json';
export const GLOBAL_DATA_DIR_NAME = 'compass';
 ...
 *
 * - All platforms: $XDG_CONFIG_HOME/compass/ if XDG_CONFIG_HOME is set
 * - Unix/macOS fallback: ~/.config/compass/
 * - Windows fallback: %APPDATA%/compass/
 */
 ...
 *
 * - All platforms: $XDG_DATA_HOME/compass/ if XDG_DATA_HOME is set
 * - Unix/macOS fallback: ~/.local/share/compass/
 * - Windows fallback: %LOCALAPPDATA%/compass/
 */
