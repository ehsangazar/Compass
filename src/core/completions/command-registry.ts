...
/**
 * Registry of all Compass CLI commands with their flags and metadata.
...
export const COMMAND_REGISTRY: CommandDefinition[] = [
  ...
  },
  {
    ...
    flags: [
      ...
      {
        name: 'concurrency',
        description: 'Max concurrent validations (defaults to env COMPASS_CONCURRENCY or 6)',
        takesValue: true,
      },
    ...
    subcommands: [
      {
        ...
        flags: [
          ...
          {
            name: 'tools',
            description: 'Install Compass skills for agents (all, none, or comma-separated tool IDs)',
            takesValue: true,
          },
          COMMON_FLAGS.json,
          COMMON_FLAGS.noInteractive,
  ...
  {
    name: 'change',
    description: 'Manage Compass change proposals (deprecated)',
    flags: [],
    subcommands: [
      {
        name: 'show',
  ...
  {
    name: 'spec',
    description: 'Manage Compass specifications',
    flags: [],
    subcommands: [
      {
        name: 'show',
