...
export interface CreateChangeOptions {
  ...
  changesDir?: string;
  /** Additional metadata to persist in the change's .compass.yaml */
...
export async function createChange(
  ...
  const changeDir = path.join(options.changesDir ?? path.join(projectRoot, 'compass', 'changes'), name);
