 ...
 * - Opt-out via COMPASS_TELEMETRY=0 or DO_NOT_TRACK=1
...
const POSTHOG_HOST = 'https://edge.compass.dev';
...
export function isTelemetryEnabled(): boolean {
  ...
  if (process.env.COMPASS_TELEMETRY === '0') {
    return false;
  }
 ...
 * @param version - The Compass version
 */
...
export async function maybeShowTelemetryNotice(): Promise<void> {
  ...
  try {
    ...
    // Display notice
    console.log(
      'Note: Compass collects anonymous usage stats. Opt out: COMPASS_TELEMETRY=0'
    );
