...
function getWelcomeText(): string[] {
  return [
    chalk.white.bold('Welcome to Compass'),
    chalk.dim('A lightweight spec-driven framework'),
    '',
    chalk.white('This setup will configure:'),
    chalk.dim('  • Agent Skills for AI tools'),
    chalk.dim('  • /compass:* slash commands'),
    '',
    chalk.white('Quick start after setup:'),
    `  ${chalk.yellow('/compass:new')}      ${chalk.dim('Create a change')}`,
    `  ${chalk.yellow('/compass:continue')} ${chalk.dim('Next artifact')}`,
    `  ${chalk.yellow('/compass:apply')}    ${chalk.dim('Implement tasks')}`,
    '',
