...
echo "======================================"
echo "Testing Compass Postinstall Script"
echo "======================================"
echo ""

# Save original environment
ORIGINAL_CI="${CI:-}"
ORIGINAL_COMPASS_NO_COMPLETIONS="${COMPASS_NO_COMPLETIONS:-}"

# Test 1: Normal install
echo "Test 1: Normal install (should print tip about completions)"
echo "--------------------------------------"
unset CI
unset COMPASS_NO_COMPLETIONS
...
echo "Test 3: COMPASS_NO_COMPLETIONS=1 (should skip silently)"
echo "--------------------------------------"
unset CI
export COMPASS_NO_COMPLETIONS=1
node scripts/postinstall.js
...
if [ -n "$ORIGINAL_COMPASS_NO_COMPLETIONS" ]; then
  export COMPASS_NO_COMPLETIONS="$ORIGINAL_COMPASS_NO_COMPLETIONS"
else
  unset COMPASS_NO_COMPLETIONS
fi
