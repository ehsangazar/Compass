...
describe('spec command', () => {
  ...
  const specsDir = path.join(testDir, 'compass', 'specs');
  const compassBin = path.join(projectRoot, 'bin', 'compass.js');
...
The system SHALL process credit card payments securely`;
  ...
  describe('spec show', () => {
    it('should display spec in text format', async () => {
      ...
      try {
        ...
        const output = execSync(`node ${compassBin} spec show auth`, {
          encoding: 'utf-8'
        });
    ...
    it('should output spec as JSON with --json flag', () => {
      ...
      try {
        process.chdir(testDir);
        const output = execSync(`node ${compassBin} spec show auth --json`, {
          encoding: 'utf-8'
        });
        ...
        expect(json.metadata.format).toBe('compass');
      } finally {
        process.chdir(originalCwd);
      }
    });
    ...
    it('should filter to show only requirements with --requirements flag (JSON only)', () => {
      ...
      try {
        process.chdir(testDir);
        const output = execSync(`node ${compassBin} spec show auth --json --requirements`, {
          encoding: 'utf-8'
        });
    ...
    it('should exclude scenarios with --no-scenarios flag (JSON only)', () => {
      ...
      try {
        process.chdir(testDir);
        const output = execSync(`node ${compassBin} spec show auth --json --no-scenarios`, {
          encoding: 'utf-8'
        });
    ...
    it('should show specific requirement with -r flag (JSON only)', () => {
      ...
      try {
        process.chdir(testDir);
        const output = execSync(`node ${compassBin} spec show auth --json -r 1`, {
          encoding: 'utf-8'
        });
  ...
  describe('spec list', () => {
    it('should list all available specs (IDs only by default)', () => {
      ...
      try {
        process.chdir(testDir);
        const output = execSync(`node ${compassBin} spec list`, {
          encoding: 'utf-8'
        });
    ...
    it('should output spec list as JSON with --json flag', () => {
      ...
      try {
        process.chdir(testDir);
        const output = execSync(`node ${compassBin} spec list --json`, {
          encoding: 'utf-8'
        });
  ...
  describe('spec validate', () => {
    it('should validate a valid spec', () => {
      ...
      try {
        process.chdir(testDir);
        const output = execSync(`node ${compassBin} spec validate auth`, {
          encoding: 'utf-8'
        });
    ...
    it('should output validation report as JSON with --json flag', () => {
      ...
      try {
        process.chdir(testDir);
        const output = execSync(`node ${compassBin} spec validate auth --json`, {
          encoding: 'utf-8'
        });
    ...
    it('should validate with strict mode', () => {
      ...
      try {
        process.chdir(testDir);
        const output = execSync(`node ${compassBin} spec validate auth --strict --json`, {
          encoding: 'utf-8'
        });
...
This section has no actual requirements`;
      ...
      try {
        ...
        let exitCode = 0;
        try {
          execSync(`node ${compassBin} spec validate invalid`, {
            encoding: 'utf-8'
          });
        } catch (error: any) {
  ...
  describe('error handling', () => {
    it('should handle non-existent spec gracefully', () => {
      ...
      try {
        ...
        let error: any;
        try {
          execSync(`node ${compassBin} spec show nonexistent`, {
            encoding: 'utf-8'
          });
        } catch (e) {
          error = e;
    ...
    it('should handle missing specs directory gracefully', async () => {
      ...
      try {
        process.chdir(testDir);
        const output = execSync(`node ${compassBin} spec list`, { encoding: 'utf-8' });
    ...
    it('should honor --no-color (no ANSI escapes)', () => {
      ...
      try {
        process.chdir(testDir);
        const output = execSync(`node ${compassBin} --no-color spec list --long`, { encoding: 'utf-8' });
