...
describe('tool-detection', () => {
  ...
  describe('SKILL_NAMES', () => {
    it('should contain all skill names matching COMMAND_IDS', () => {
      ...
      expect(SKILL_NAMES).toContain('compass-explore');
      expect(SKILL_NAMES).toContain('compass-new-change');
      expect(SKILL_NAMES).toContain('compass-continue-change');
      expect(SKILL_NAMES).toContain('compass-apply-change');
      expect(SKILL_NAMES).toContain('compass-ff-change');
      expect(SKILL_NAMES).toContain('compass-sync-specs');
      expect(SKILL_NAMES).toContain('compass-archive-change');
      expect(SKILL_NAMES).toContain('compass-bulk-archive-change');
      expect(SKILL_NAMES).toContain('compass-verify-change');
      expect(SKILL_NAMES).toContain('compass-onboard');
      expect(SKILL_NAMES).toContain('compass-propose');
    });
  });
  ...
  describe('getToolSkillStatus', () => {
    ...
    it('should detect when one skill exists', async () => {
      const skillDir = path.join(testDir, '.claude', 'skills', 'compass-explore');
