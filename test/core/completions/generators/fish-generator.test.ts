  ...
  describe('generate', () => {
    it('should generate valid fish completion script with header', () => {
      const commands: CommandDefinition[] = [
        {
          name: 'init',
          description: 'Initialize Compass',
          flags: [],
        },
      ];
      ...
      expect(script).toContain('# Fish completion script for Compass CLI');
      expect(script).toContain('function __fish_compass');
    });
    ...
    it('should generate helper functions for Fish', () => {
      ...
      expect(script).toContain('function __fish_compass_using_subcommand');
      expect(script).toContain('function __fish_compass_no_subcommand');
    ...
    it('should include all commands with descriptions', () => {
      ...
      expect(script).toContain("complete -c compass");
      expect(script).toContain("-a 'init'");
      expect(script).toContain("'Initialize Compass'");
    ...
    it('should handle commands with subcommands', () => {
      ...
      expect(script).toContain("__fish_compass_using_subcommand change");
    });
    ...
    it('should handle positional arguments for change-id', () => {
      ...
      expect(script).toContain('__fish_compass_changes');
    });
    ...
    it('should handle positional arguments for spec-id', () => {
      ...
      expect(script).toContain('__fish_compass_specs');
    });
    ...
    it('should handle positional arguments for change-or-spec-id', () => {
      ...
      expect(script).toContain('__fish_compass_items');
    });
    ...
    it('should handle positional arguments for schema names', () => {
      ...
      expect(script).toContain('__fish_compass_schemas');
      expect(script).toContain('compass __complete schemas 2>/dev/null');
    });
    ...
    it('should generate dynamic completion helper for changes', () => {
      ...
      expect(script).toContain('function __fish_compass_changes');
      expect(script).toContain('compass __complete changes 2>/dev/null');
    ...
    it('should generate dynamic completion helper for specs', () => {
      ...
      expect(script).toContain('function __fish_compass_specs');
      expect(script).toContain('compass __complete specs 2>/dev/null');
    });
    ...
    it('should generate dynamic completion helper for items', () => {
      ...
      expect(script).toContain('function __fish_compass_items');
      expect(script).toContain('__fish_compass_changes');
      expect(script).toContain('__fish_compass_specs');
    });
