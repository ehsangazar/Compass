...
describe('ZshGenerator', () => {
  ...
  describe('generate', () => {
    it('should generate valid zsh completion script with header', () => {
      ...
      expect(script).toContain('#compdef compass');
      expect(script).toContain('# Zsh completion script for Compass CLI');
      expect(script).toContain('_compass() {');
    });
    ...
    it('should include all commands in the command list', () => {
      ...
      expect(script).toContain("'init:Initialize Compass'");
    ...
    it('should generate command completion functions', () => {
      ...
      expect(script).toContain('_compass_init() {');
      expect(script).toContain('_compass_validate() {');
    });
    ...
    it('should handle commands with subcommands', () => {
      ...
      expect(script).toContain('_compass_change_show() {');
      expect(script).toContain('_compass_change_list() {');
    });
    ...
    it('should handle positional arguments for change-id', () => {
      ...
      expect(script).toContain("'*: :_compass_complete_changes'");
    });
    ...
    it('should handle positional arguments for spec-id', () => {
      ...
      expect(script).toContain("'*: :_compass_complete_specs'");
    });
    ...
    it('should handle positional arguments for change-or-spec-id', () => {
      ...
      expect(script).toContain("'*: :_compass_complete_items'");
    });
    ...
    it('should handle positional arguments for schema names', () => {
      ...
      expect(script).toContain("'*: :_compass_complete_schemas'");
      expect(script).toContain('_compass_complete_schemas()');
    });
    ...
    it('should sanitize command names with hyphens for function names', () => {
      ...
      expect(script).toContain('_compass_my_command() {');
    });
    ...
    it('should handle complex nested subcommands with flags', () => {
      ...
      expect(script).toContain('_compass_spec() {');
      expect(script).toContain('_compass_spec_validate() {');
      expect(script).toContain('--strict');
      expect(script).toContain('--json');
      expect(script).toContain("'*: :_compass_complete_specs'");
    });
    ...
    it('should generate script that ends with compdef registration', () => {
      ...
      expect(script.trim().endsWith('compdef _compass compass')).toBe(true);
    });
    ...
    it('should handle commands with no flags', () => {
      ...
      expect(script).toContain('_compass_view() {');
