...
describe('command-generation/adapters', () => {
  ...
  describe('claudeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.claude', 'commands', 'compass', 'explore.md'));
    });

    it('should generate correct file path for different command IDs', () => {
      expect(claudeAdapter.getFilePath('new')).toBe(path.join('.claude', 'commands', 'compass', 'new.md'));
      expect(claudeAdapter.getFilePath('bulk-archive')).toBe(path.join('.claude', 'commands', 'compass', 'bulk-archive.md'));
    });
    ...
    it('should format file with correct YAML frontmatter', () => {
      ...
      expect(output).toContain('name: Compass Explore');
  ...
  describe('cursorAdapter', () => {
    ...
    it('should generate correct file path with compass- prefix', () => {
      const filePath = cursorAdapter.getFilePath('explore');
      expect(filePath).toBe(path.join('.cursor', 'commands', 'compass-explore.md'));
    });

    it('should generate correct file paths for different commands', () => {
      expect(cursorAdapter.getFilePath('new')).toBe(path.join('.cursor', 'commands', 'compass-new.md'));
      expect(cursorAdapter.getFilePath('bulk-archive')).toBe(path.join('.cursor', 'commands', 'compass-bulk-archive.md'));
    });
    ...
    it('should format file with Cursor-specific frontmatter', () => {
      ...
      expect(output).toContain('---\n');
      expect(output).toContain('name: /compass-explore');
      expect(output).toContain('id: compass-explore');
      expect(output).toContain('category: Workflow');
      expect(output).toContain('description: Enter explore mode for thinking');
      expect(output).toContain('---\n\n');
      expect(output).toContain('This is the command body.');
  ...
  describe('windsurfAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.windsurf', 'workflows', 'compass-explore.md'));
    });
  ...
  describe('amazonQAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.amazonq', 'prompts', 'compass-explore.md'));
    });
  ...
  describe('antigravityAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.agent', 'workflows', 'compass-explore.md'));
    });
  ...
  describe('auggieAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.augment', 'commands', 'compass-explore.md'));
    });
  ...
  describe('bobAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.bob', 'commands', 'compass-explore.md'));
    });

    it('should generate correct file paths for different commands', () => {
      expect(bobAdapter.getFilePath('new')).toBe(path.join('.bob', 'commands', 'compass-new.md'));
      expect(bobAdapter.getFilePath('bulk-archive')).toBe(path.join('.bob', 'commands', 'compass-bulk-archive.md'));
    });
    ...
    it('should transform colon command references to hyphen format', () => {
      const contentWithRefs: CommandContent = {
        ...sampleContent,
        body: 'Run /compass:apply to implement. Then use /compass:verify.',
      };
      const output = bobAdapter.formatFile(contentWithRefs);
      expect(output).toContain('/compass-apply');
      expect(output).toContain('/compass-verify');
      expect(output).not.toContain('/compass:apply');
      expect(output).not.toContain('/compass:verify');
    });
  ...
  describe('codexAdapter', () => {
    ...
    it('should generate path ending with correct structure', () => {
      const filePath = codexAdapter.getFilePath('explore');
      expect(filePath).toMatch(/prompts[/\\]compass-explore\.md$/);
    });
    ...
    it('should default to homedir/.codex', () => {
      ...
      try {
        const filePath = codexAdapter.getFilePath('explore');
        const expected = path.join(os.homedir(), '.codex', 'prompts', 'compass-explore.md');
    ...
    it('should respect CODEX_HOME env var', () => {
      ...
      try {
        const filePath = codexAdapter.getFilePath('explore');
        expect(filePath).toBe(path.join(path.resolve('/custom/codex-home'), 'prompts', 'compass-explore.md'));
      } finally {
        if (original !== undefined) {
          process.env.CODEX_HOME = original;
        } else {
  ...
  describe('codebuddyAdapter', () => {
    ...
    it('should generate correct file path with nested compass folder', () => {
      const filePath = codebuddyAdapter.getFilePath('explore');
      expect(filePath).toBe(path.join('.codebuddy', 'commands', 'compass', 'explore.md'));
    });
  ...
  describe('continueAdapter', () => {
    ...
    it('should generate correct file path with .prompt extension', () => {
      ...
      expect(filePath).toBe(path.join('.continue', 'prompts', 'compass-explore.prompt'));
    });
  ...
  describe('costrictAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.cospec', 'compass', 'commands', 'compass-explore.md'));
    });
  ...
  describe('crushAdapter', () => {
    ...
    it('should generate correct file path with nested compass folder', () => {
      ...
      expect(filePath).toBe(path.join('.crush', 'commands', 'compass', 'explore.md'));
    });
  ...
  describe('factoryAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.factory', 'commands', 'compass-explore.md'));
    });
  ...
  describe('geminiAdapter', () => {
    ...
    it('should generate correct file path with .toml extension', () => {
      ...
      expect(filePath).toBe(path.join('.gemini', 'commands', 'compass', 'explore.toml'));
    });
  ...
  describe('githubCopilotAdapter', () => {
    ...
    it('should generate correct file path with .prompt.md extension', () => {
      ...
      expect(filePath).toBe(path.join('.github', 'prompts', 'compass-explore.prompt.md'));
    });
  ...
  describe('iflowAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.iflow', 'commands', 'compass-explore.md'));
    });
  ...
  describe('kilocodeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.kilocode', 'workflows', 'compass-explore.md'));
    });
  ...
  describe('opencodeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.opencode', 'commands', 'compass-explore.md'));
    });
    ...
    it('should transform colon-based command references to hyphen-based', () => {
      const contentWithCommands: CommandContent = {
        ...sampleContent,
        body: 'Use /compass:new to start, then /compass:apply to implement.',
      };
      const output = opencodeAdapter.formatFile(contentWithCommands);
      expect(output).toContain('/compass-new');
      expect(output).toContain('/compass-apply');
      expect(output).not.toContain('/compass:new');
      expect(output).not.toContain('/compass:apply');
    });
    ...
    it('should handle multiple command references in body', () => {
      const contentWithMultipleCommands: CommandContent = {
        ...sampleContent,
        body: `/compass:explore for ideas
/compass:new to create
/compass:continue to proceed
/compass:apply to implement`,
      };
      const output = opencodeAdapter.formatFile(contentWithMultipleCommands);
      expect(output).toContain('/compass-explore');
      expect(output).toContain('/compass-new');
      expect(output).toContain('/compass-continue');
      expect(output).toContain('/compass-apply');
    });
  });
  ...
  describe('qoderAdapter', () => {
    ...
    it('should generate correct file path with nested compass folder', () => {
      ...
      expect(filePath).toBe(path.join('.qoder', 'commands', 'compass', 'explore.md'));
    });
  ...
  describe('qwenAdapter', () => {
    ...
    it('should generate correct file path with .toml extension', () => {
      ...
      expect(filePath).toBe(path.join('.qwen', 'commands', 'compass-explore.toml'));
    });
  ...
  describe('piAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.pi', 'prompts', 'compass-explore.md'));
    });

    it('should generate correct file paths for different commands', () => {
      expect(piAdapter.getFilePath('new')).toBe(path.join('.pi', 'prompts', 'compass-new.md'));
      expect(piAdapter.getFilePath('bulk-archive')).toBe(path.join('.pi', 'prompts', 'compass-bulk-archive.md'));
    });
    ...
    it('should transform command references from colon to hyphen format', () => {
      const contentWithRefs: CommandContent = {
        ...sampleContent,
        body: 'Run /compass:apply to implement. Then /compass:archive when done.',
      };

      const output = piAdapter.formatFile(contentWithRefs);
      expect(output).toContain('/compass-apply');
      expect(output).toContain('/compass-archive');
      expect(output).not.toContain('/compass:apply');
    });
    ...
    it('should inject template arguments into the input section', () => {
      const contentWithInput: CommandContent = {
        ...sampleContent,
        body: '**Input**: The argument after `/compass:explore` is the topic.\n\n**Steps**\n1. Think.',
      };
  ...
  describe('roocodeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.roo', 'commands', 'compass-explore.md'));
    });
  ...
  describe('cross-platform path handling', () => {
    it('Claude adapter uses path.join for paths', () => {
      ...
      expect(filePath.split(path.sep)).toEqual(['.claude', 'commands', 'compass', 'test.md']);
    });

    it('Cursor adapter uses path.join for paths', () => {
      const filePath = cursorAdapter.getFilePath('test');
      expect(filePath.split(path.sep)).toEqual(['.cursor', 'commands', 'compass-test.md']);
    });

    it('Windsurf adapter uses path.join for paths', () => {
      const filePath = windsurfAdapter.getFilePath('test');
      expect(filePath.split(path.sep)).toEqual(['.windsurf', 'workflows', 'compass-test.md']);
    });
