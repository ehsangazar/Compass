...
describe('interactive utilities', () => {
  let originalCompassInteractive: string | undefined;
  let originalCI: string | undefined;
  let originalStdinIsTTY: boolean | undefined;

  beforeEach(() => {
    // Save original environment
    originalCompassInteractive = process.env.OPEN_SPEC_INTERACTIVE;
  ...
  afterEach(() => {
    ...
    if (originalCompassInteractive !== undefined) {
      process.env.OPEN_SPEC_INTERACTIVE = originalCompassInteractive;
    } else {
      delete process.env.OPEN_SPEC_INTERACTIVE;
    }
